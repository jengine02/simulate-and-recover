...
def generate_ss(a, v, t, N, num_samples):
...
def simulate_ss(Rpred, Mpred, Vpred, N, num_samples):
...
def calculate_estimates(Robs, Mobs, Vobs):
...
def calculate_bias(v, a, t, v_est, a_est, t_est):
